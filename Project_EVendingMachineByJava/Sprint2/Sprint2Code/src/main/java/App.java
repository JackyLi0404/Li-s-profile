...
public class App extends NormalUtil{
 ...
 //      Product cola = new Product("cola", "Drinks",3,10,0);
 //      Product sprite = new Product("sprite","Drinks", 3.5,15, 0);
        helper();
        homepage(test,transaction);
    }
            ...
            switch(selection){
                case 1 :
                    ...
                    if(Signup_success==false){
                        ...
                        transaction = new Transaction(date,time,username);
                        MainMenu.displayMainMenu(productMenus, transaction);
                    }
                    break;
                case 2:
