...
public class UsermenuTest {
    ...
    void TestGetcurrentTable(){
        ...
        sdf = new SimpleDateFormat("yyyy-MM-dd");
        String dateNowStr = sdf.format(today);
        Table table = UserMenu.getcurrentTable(currencies,times);
        String d = table.getDate();
        assertEquals(dateNowStr, d);
    }

    @Test
    void TestConvert(){
        String converted = UserMenu.convert("AUD","USD", times,100.0);
    ...
    void TestConvertEmptytime(){
        ...
        String converted = UserMenu.convert("AUD","USD", notimes,100.0);
        assertNull(converted);
    }

    @Test
    void TestConvertNoExchange(){
        String converted = UserMenu.convert("USD","AUD", times,100.0);
    ...
    void TestSummary(){
        ...
        try{
            UserMenu.conversionsummary(sdf.parse("2020-01-01"),sdf.parse("2021-01-01"),"AUD","USD",times);
    ...
    void TestSummaryEmptytime(){
        ...
        List<Time> notimes = new ArrayList<>();
        try{
            UserMenu.conversionsummary(sdf.parse("2020-01-01"),sdf.parse("2021-01-01"),"AUD","USD",notimes);
        }catch(ParseException e){
            System.out.println(e);
        }
    ...
    void TestSummaryWrongperiod(){
        ...
        List<Time> notimes = new ArrayList<>();
        try{
            UserMenu.conversionsummary(sdf.parse("2021-01-01"),sdf.parse("2020-01-01"),"AUD","USD",times);
        }catch(ParseException e){
            System.out.println(e);
        }
